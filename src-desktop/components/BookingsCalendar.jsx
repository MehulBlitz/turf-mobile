...
export default function BookingsCalendar({ userId }) {
  ...
  return (
    <div className="bookings-calendar-page flex-1 flex flex-col pb-24">
      <header className="p-6 flex items-center gap-4 bg-white/50 backdrop-blur-md sticky top-0 z-20 border-b border-zinc-200 desktop-page-header">
        <h2 className="text-xl font-display font-bold text-zinc-900">Bookings Calendar</h2>
      </header>

      <div className="flex-1 overflow-y-auto">
        <div className="calendar-content-shell max-w-6xl mx-auto p-6">
          <div className="bookings-calendar-layout">
            <div className="bookings-calendar-left">
              ...
              <div className="bookings-calendar-stats grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="bookings-calendar-right">
              {selectedDate ? (
                <div className="space-y-4">
                  ...
                  {selectedDateBookings.length > 0 ? (
                    ...
                    <DashboardEmptyState
                      ...
                      message="Pick another date in the calendar to review your scheduled matches."
                      compact
                    />
                  )}
                </div>
                ...
                <DashboardEmptyState
                  icon={CalendarDays}
                  title="Select a date"
                  message="Choose any day in the calendar to open detailed booking cards."
                  compact
                />
              )}
            </div>
