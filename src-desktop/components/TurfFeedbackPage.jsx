...
export default function TurfFeedbackPage({ user, turf, onBack, onFeedbackUpdate }) {
  ...
  return (
    <div className="desktop-feedback-page flex-1 flex flex-col pb-24">
      <header className="p-6 flex items-center gap-4 bg-white/95 backdrop-blur-md sticky top-0 z-20 border-b border-zinc-200 desktop-page-header">
      ...
      <div className="desktop-feedback-content p-6 space-y-6">
        {error && (
        ...
        <section className="space-y-4">
          ...
          {loading ? (
            ...
            <div className="desktop-feedback-comment-list space-y-3">
        ...
        <section className="space-y-4">
          ...
          {loading ? (
            ...
            <div className="desktop-feedback-rating-list space-y-3">
              {feedback.map((item) => (
