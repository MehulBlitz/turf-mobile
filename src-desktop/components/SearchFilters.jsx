...
export default function SearchFilters({
  ...
  return (
    <div className="relative desktop-filters-root">
      <motion.button
        ...
        {isOpen && (
          <>
            ...
            <motion.div
              ...
              exit={{ opacity: 0, y: -10 }}
              className="desktop-filters-panel absolute top-full left-0 right-0 mt-2 bg-white border border-zinc-100 rounded-2xl shadow-xl z-50 p-6 space-y-6 max-h-[70vh] overflow-y-auto"
            >
              {/* Price Range */}
              <div>
